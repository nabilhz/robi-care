...
export interface backendInterface {
     ...
     */
    listContactEnquiries(): Promise<Array<ContactEnquiry>>;
     ...
     */
    submitContactEnquiry(name: string, email: string, organisation: string, message: string): Promise<SubmitResult>;
}
