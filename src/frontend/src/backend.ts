...
import type { Cell as _Cell, Error as _Error, Result as _Result, Result__1 as _Result__1, SubmitResult as _SubmitResult, UserRole as _UserRole, Value as _Value } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async listContactEnquiries(): Promise<Array<ContactEnquiry>> {
        if (this.processError) {
            try {
                const result = await this.actor.listContactEnquiries();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitContactEnquiry(arg0: string, arg1: string, arg2: string, arg3: string): Promise<SubmitResult> {
        if (this.processError) {
            try {
